...
async function initSpotifyPlayer(cardEl, title, artist) {
  ...
  playerEl.innerHTML = `
    <div class="spotify-player-collapsed" onclick="toggleSpotifyEmbed(this)" title="Expand Spotify player">
    ...
    <div class="spotify-embed-container" style="display:none;">
      ...
      <button class="spotify-collapse-btn" onclick="toggleSpotifyEmbed(this.previousElementSibling)">Collapse ▲</button>
    </div>
  `;
}
