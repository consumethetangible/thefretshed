...
function buildSettingsDrawer() {
  ...
  body.innerHTML = `
    ...
    <div class="settings-section">
      ...
      <button class="settings-action-btn" id="spotify-connect-btn" onclick="spotifyLogin()">
        ...
        <div class="settings-action-info">
          <div class="settings-action-label">Connect Spotify</div>
          <div class="settings-action-sub">Adds inline players to curriculum song cards</div>
        </div>
      </button>
    </div>
