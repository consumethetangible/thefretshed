...
const PHASES = [
  ...
  },
  {
    ...
    songs:[
      ...
      { num:8, title:'Texas Flood', artist:'Stevie Ray Vaughan', tuning:'Eb (½ step down)', teaches:"Slow blues at its most demanding — not the notes but the conviction. SRV's vibrato and bending intensity is a direct test of everything Phase 2 blues built. The groove lives in your whole body or it doesn't.", resources:"300 Blues, Rock & Jazz Licks — SRV/Texas blues section.", weeksFocus:'TBD', skills:['slow blues','SRV vibrato','bending intensity','tone as expression'], status:'future' },
      { num:9, title:'The Rover', artist:'Led Zeppelin', tuning:'Standard', teaches:"Mixolydian riff architecture with an open-tuning feel even in standard. Page's compositional instinct — the riff itself implies a full harmonic world. Solo uses space as aggressively as notes.", resources:"300 Blues, Rock & Jazz Licks — Jimmy Page rock section.", weeksFocus:'TBD', skills:['Mixolydian','riff architecture','space & phrasing','Page compositional voice'], status:'future' },
      { num:10, title:'Stargazer', artist:'Rainbow', tuning:'Standard', teaches:"Blackmore's neoclassical vocabulary in a hard rock frame — harmonic minor runs, ascending/descending lines, dramatic dynamics. The bridge between your blues-rock foundation and the harmonic minor world of your own black metal writing.", resources:"Heavy Metal Bible (Ch. 4 — Harmonic Minor). 300 Blues, Rock & Jazz Licks — Blackmore rock section.", weeksFocus:'TBD', skills:['harmonic minor','neoclassical phrasing','Blackmore vocabulary','dynamic arc'], status:'future' },
      { num:11, title:'While My Guitar Gently Weeps', artist:'The Beatles', tuning:'Standard', teaches:"Harrison's minor chord movement over a pedal tone — unexpected harmonic shifts that have no precedent in blues vocabulary. By Phase 4 the technical ceiling isn't technique, it's harmonic imagination. This song expands that ceiling directly.", resources:"Guitar Chords in Context — chord movement and substitution chapters.", weeksFocus:'TBD', skills:['minor harmony','pedal tone','chord movement','harmonic imagination'], status:'future' },
      { num:12, title:'Hideaway', artist:'Freddie King', tuning:'Standard', teaches:"The foundational instrumental blues shuffle — jumping between positions, call-and-response without a vocalist, and the first purely instrumental blues vocabulary test. Everything that follows in blues lead playing has this as a ancestor.", resources:"Complete Blues Guitar — Freddie King / Texas blues sections.", weeksFocus:'TBD', skills:['shuffle blues','position jumping','instrumental blues','Texas blues'], status:'future' },
      { num:13, title:'Red House', artist:'Jimi Hendrix', tuning:'Eb (½ step down)', teaches:"Slow blues as pure vocal phrasing on guitar — every bend talks, every rest breathes. This is where Hendrix stops being a rock guitarist and becomes a bluesman. The antidote to speed.", resources:"300 Blues, Rock & Jazz Licks — Hendrix blues section. Complete Blues Guitar — slow blues chapters.", weeksFocus:'TBD', skills:['slow blues','vocal phrasing','Hendrix blues voice','space & restraint'], status:'future' },
      { num:14, title:'Aqualung', artist:'Jethro Tull', tuning:'Standard', teaches:"Acoustic/electric contrast in a single song, chromatic riffing, Martin Barre's raw and unpolished lead style — the anti-shred. The acoustic intro is a fingerpicking challenge; the electric sections are all attitude over technique.", resources:"Inside-Outside Guitar Soloing — chromatic and non-diatonic approach chapters.", weeksFocus:'TBD', skills:['acoustic/electric contrast','chromatic riffing','Barre lead style','prog entry point'], status:'future' },
      { num:15, title:'Roundabout', artist:'Yes', tuning:'Standard', teaches:"Steve Howe's acoustic intro is a landmark fingerstyle moment. The electric rhythm work demands real harmonic awareness — modal chord movement far outside blues vocabulary. A prog entry point that rewards patience.", resources:"Guitar Chords in Context — extended harmony and modal movement chapters.", weeksFocus:'TBD', skills:['fingerstyle intro','modal harmony','Steve Howe vocabulary','prog harmony'], status:'future' },
    ],
    weeks:[]
  },
  {
    ...
    songs:[
      ...
      { num:5, title:'Advent', artist:'Opeth', tuning:'C# standard (or drop B)', teaches:"Opeth's acoustic/electric duality at its most direct — clean fingerpicked passages bleeding into heavy riffing without warning. Mikael Åkerfeldt's approach to dynamics as composition: the quiet isn't a break, it's load-bearing. Essential vocabulary for NGC's own textural writing.", resources:"Heavy Metal Bible — progressive metal and extreme metal chapters.", weeksFocus:'TBD', skills:['acoustic/electric dynamics','Opeth vocabulary','progressive death metal','textural composition'], status:'future' },
      { num:6, title:'21st Century Schizoid Man', artist:'King Crimson', tuning:'Standard', teaches:"Fripp's tritone riff is one of the most aggressive and angular things in rock — no blues DNA, pure dissonance with jazz-fusion aggression underneath. The solo section is free improvisation over chaos. Nothing else on the list prepares you for this; it opens a completely different vocabulary.", resources:"Inside-Outside Guitar Soloing — outside playing and dissonance chapters.", weeksFocus:'TBD', skills:['tritone riffing','angular phrasing','jazz-fusion aggression','atonal vocabulary'], status:'future' },
      { num:7, title:'Achilles Last Stand', artist:'Led Zeppelin', tuning:'Standard', teaches:"Page's layered modal riffing and the long-form arc of a 10-minute composition. Where Stairway is a dynamic journey, Achilles is relentless forward momentum. The rhythm guitar work alone — open-tuning feel in standard, galloping modal riff — is a full study.", resources:"300 Blues, Rock & Jazz Licks — Jimmy Page rock section.", weeksFocus:'TBD', skills:['modal riffing','long-form composition','Page rhythm vocabulary','sustained intensity'], status:'future' },
    ],
    weeks:[]
  }
];
